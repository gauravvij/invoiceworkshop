...
const publicUrls = ['/', '/proforma-invoice-generator/', '/quotation-generator/', '/work-order-generator/', '/purchase-order-generator/', '/estimate-generator/', '/construction-invoice-template/', '/contractor-invoice-template/', '/invoice-template/', '/receipt-generator/', '/credit-note-generator/', '/vat-invoice-template-uk/', '/gst-invoice-format-india/', '/tax-invoice-template-australia/', '/gst-hst-invoice-template-canada/', '/about/', '/privacy/', '/terms/', '/contact/'];
