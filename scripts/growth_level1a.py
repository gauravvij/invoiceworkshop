...
TEMPLATES = (
    ...
    (
        "human_roundup", 1, "roundup_suggestion", "{subject_value}", "{opening_value}",
        "{context_value}", "{fit_value}", "{close_value}", 900,
    ),
    (
...
PILOT = (
    ...
    },
    {
        ...
        "organization": "US Chamber CO",
        "external_page_url": "https://www.uschamber.com/co/run/finance/free-accounting-tools-for-small-businesses",
        "verified_contact_route": "https://www.uschamber.com/co/about-us",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "co@uschamber.com",
        "form_handler": None,
        "action_type": "roundup_suggestion",
        "target_url": "https://invoiceworkshop.com/",
        "allowed_intent": "Suggest a free invoicing tool for an existing free-tools roundup.",
        "claims": ["free_no_signup_local"],
        "relevance": ["free", "tools", "small business"],
        "template_id": "human_roundup",
        "subject": "Free invoicing tool for your free accounting tools list",
        "opening": "Hello CO team,",
        "context": "I came across your roundup of free accounting tools for small businesses.",
        "fit": "InvoiceWorkshop is a free invoice tool that works without signup and keeps the workspace in the browser. It may be worth considering alongside the free options you already list:",
        "close": "If it’s useful for your readers, feel free to include it.",
        "title": "Free accounting tools for small businesses",
        "excerpt": "A CO roundup of free accounting and finance tools for small businesses, linking to several third-party products.",
        "prospect": {
            "type": "editorial", "score": 88, "risk": "low", "channel": "small_business",
            "why_fit": "The page is a curated roundup of free accounting tools for small businesses and already links to several third-party products.",
            "audience": "Small-business owners looking for free finance and accounting tools.",
            "evidence": "The live page links to five separate third-party invoicing and accounting products and publishes co@uschamber.com as the CO contact address.",
            "confidence": "high",
        },
    },
    {
        "domain": "exayard.com",
        "organization": "Exayard",
        "external_page_url": "https://exayard.com/blog/construction-invoice-template",
        "verified_contact_route": "https://exayard.com/contact",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "support@exayard.com",
        "form_handler": None,
        "action_type": "roundup_suggestion",
        "target_url": "https://invoiceworkshop.com/construction-invoice-template/",
        "allowed_intent": "Suggest a free construction invoice tool for an existing template comparison.",
        "claims": ["free_no_signup_local", "browser_pdf_privacy"],
        "relevance": ["construction", "invoice", "template"],
        "template_id": "human_roundup",
        "subject": "Free construction invoice tool for your template guide",
        "opening": "Hello Exayard team,",
        "context": "I came across your construction invoice template guide and the tools you compare in it.",
        "fit": "InvoiceWorkshop is a free browser-based invoice tool that requires no signup and generates the PDF directly in the browser. Its construction page covers jobsite details, labor and materials, deposits, retainage and change orders:",
        "close": "If it fits the guide, feel free to include it.",
        "title": "Free construction invoice template guide",
        "excerpt": "A construction invoice template guide comparing a range of third-party invoicing and accounting tools.",
        "prospect": {
            "type": "editorial", "score": 86, "risk": "medium", "channel": "contractor",
            "why_fit": "The guide compares construction invoicing tools and links to nine third-party products.",
            "audience": "Contractors and construction businesses looking for invoice templates and tools.",
            "evidence": "The live page links to nine separate third-party invoicing products and publishes support@exayard.com on its contact page.",
            "confidence": "medium",
        },
    },
    {
        "domain": "toranaccounting.com",
        "organization": "Toran Accounting",
        "external_page_url": "https://toranaccounting.com/blog/retainage-in-construction-accounting/",
        "verified_contact_route": "https://toranaccounting.com/blog/retainage-in-construction-accounting/",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "info@toranaccounting.com",
        "form_handler": None,
        "action_type": "resource_suggestion",
        "target_url": "https://invoiceworkshop.com/construction-invoice-template/",
        "allowed_intent": "Suggest a construction invoice tool alongside an article about retainage.",
        "claims": ["free_no_signup_local"],
        "relevance": ["retainage", "construction", "accounting"],
        "template_id": "human_resource",
        "subject": "Free construction invoice tool to pair with your retainage guide",
        "opening": "Hello Toran Accounting team,",
        "context": "I read your article on recording, tracking and releasing retainage in construction accounting.",
        "fit": "InvoiceWorkshop is a free invoice tool that works without signup and keeps the workspace in the browser. Its construction invoice page covers deposits, progress draws and retainage, so it may be a practical companion for contractors reading your article:",
        "close": "If it is useful for your clients, feel free to link it.",
        "title": "Retainage accounting in construction",
        "excerpt": "An accounting firm article explaining how to record, track and release retainage on construction projects.",
        "prospect": {
            "type": "resource", "score": 84, "risk": "low", "channel": "accounting",
            "why_fit": "The article explains construction retainage in detail, which is exactly what the InvoiceWorkshop construction page helps a contractor record.",
            "audience": "Contractors and construction bookkeepers handling retainage and progress billing.",
            "evidence": "The live article covers retainage recording and release, and the site publishes info@toranaccounting.com.",
            "confidence": "high",
        },
    },
    {
        "domain": "dc.aiga.org",
        "organization": "AIGA DC",
        "external_page_url": "https://dc.aiga.org/freelance-101-tax-considerations-and-resources/",
        "verified_contact_route": "https://dc.aiga.org/about-us/",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "talktous@dc.aiga.org",
        "form_handler": None,
        "action_type": "resource_suggestion",
        "target_url": "https://invoiceworkshop.com/",
        "allowed_intent": "Suggest a free invoicing tool for a design association freelancer resource page.",
        "claims": ["free_no_signup_local"],
        "relevance": ["freelance", "resource", "design"],
        "template_id": "human_resource",
        "subject": "Free invoicing tool for your freelancer resources",
        "opening": "Hello AIGA DC team,",
        "context": "I came across your freelancing page covering tax considerations and resources for designers.",
        "fit": "InvoiceWorkshop is a free invoicing tool that requires no signup and remembers business, customer and item information locally in the browser. It may be a useful addition for members invoicing clients directly:",
        "close": "If you think it belongs in the resource list, feel free to include it.",
        "title": "Freelance tax considerations and resources",
        "excerpt": "A design association chapter page collecting tax and business resources for freelance designers.",
        "prospect": {
            "type": "resource", "score": 82, "risk": "low", "channel": "freelancer",
            "why_fit": "A non-commercial design association page that curates practical business resources for freelance designers.",
            "audience": "Freelance designers invoicing clients directly.",
            "evidence": "The live page links to eight external resources and the chapter publishes talktous@dc.aiga.org.",
            "confidence": "high",
        },
    },
    {
        "domain": "nari.org",
        "organization": "NARI",
        "external_page_url": "https://www.nari.org/business-success-tools/",
        "verified_contact_route": "https://www.nari.org/business-success-tools/",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "info@nari.org",
        "form_handler": None,
        "action_type": "resource_suggestion",
        "target_url": "https://invoiceworkshop.com/construction-invoice-template/",
        "allowed_intent": "Suggest a construction invoice tool for a remodeling association business-tools page.",
        "claims": ["free_no_signup_local"],
        "relevance": ["remodeling", "business", "tools"],
        "template_id": "human_resource",
        "subject": "Free invoicing tool for your business success tools",
        "opening": "Hello NARI team,",
        "context": "I came across your business success tools page for remodeling professionals.",
        "fit": "InvoiceWorkshop is a free invoice tool that works without signup and keeps the workspace in the browser. Its construction invoice page covers jobsite details, labor and materials, deposits and change orders:",
        "close": "If it fits your member resources, feel free to include it.",
        "title": "NARI business success tools",
        "excerpt": "A remodeling industry association page collecting business tools and resources for member contractors.",
        "prospect": {
            "type": "resource", "score": 80, "risk": "low", "channel": "contractor",
            "why_fit": "A remodeling trade association page collecting practical business tools for contractor members.",
            "audience": "Remodeling contractors running their own businesses.",
            "evidence": "The live page is publicly reachable and collects business tools; NARI publishes info@nari.org.",
            "confidence": "medium",
        },
    },
    {
        ...
        "external_page_url": "https://www.authorsguild.org/resources/",
        "verified_contact_route": "https://www.authorsguild.org/resources/",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "staff@authorsguild.org",
        "form_handler": None,
        "action_type": "resource_suggestion",
        "target_url": "https://invoiceworkshop.com/",
        "allowed_intent": "Suggest a free invoicing tool for a writers association resource library.",
        "claims": ["free_no_signup_local"],
        "relevance": ["writer", "resource", "library"],
        "template_id": "human_resource",
        "subject": "Free invoicing tool for your resource library",
        "opening": "Hello Authors Guild team,",
        "context": "I came across your resource library for working writers.",
        "fit": "InvoiceWorkshop is a free invoicing tool that requires no signup and remembers business, customer and item information locally in the browser. It may be useful for members invoicing publishers and clients directly:",
        "close": "If it is useful for your members, feel free to include it.",
        "title": "Authors Guild resource library",
        "excerpt": "A writers association resource library collecting practical guidance for working authors.",
        "prospect": {
            "type": "resource", "score": 78, "risk": "low", "channel": "freelancer",
            "why_fit": "A writers association resource library serving authors who invoice publishers and clients directly.",
            "audience": "Working writers and authors billing publishers and clients.",
            "evidence": "The live resource library is publicly reachable and the Guild publishes staff@authorsguild.org.",
            "confidence": "medium",
        },
    },
    {
        "domain": "founderreports.com",
        "organization": "Founder Reports",
        "external_page_url": "https://founderreports.com/invoicing-tools-for-small-businesses/",
        "verified_contact_route": "https://founderreports.com/contact/",
        "contact_kind": "email",
        "execution_class": "level1a_email",
        "recipient": "info@founderreports.com",
        "form_handler": None,
        "action_type": "roundup_suggestion",
        "target_url": "https://invoiceworkshop.com/",
        "allowed_intent": "Suggest a free invoicing option for an existing invoicing tools roundup.",
        "claims": ["free_no_signup_local"],
        "relevance": ["invoicing", "freelancer", "tools"],
        "template_id": "human_roundup",
        "subject": "Free invoicing option for your freelancer tools list",
        "opening": "Hello Founder Reports team,",
        "context": "I came across your article on invoicing tools for freelancers and small businesses.",
        "fit": "InvoiceWorkshop is a free invoice tool that works without signup and keeps the workspace in the browser, which makes it a slightly different option to the subscription products you cover:",
        "close": "If it is useful for your readers, feel free to include it.",
        "title": "Invoicing tools for freelancers and small businesses",
        "excerpt": "A business publication roundup of invoicing tools for freelancers and small businesses, linking to four third-party products.",
        "prospect": {
            "type": "editorial", "score": 90, "risk": "low", "channel": "freelancer",
            "why_fit": "An editorial roundup of invoicing tools for freelancers and small businesses that already links to four third-party products, none of which is free without signup.",
            "audience": "Freelancers and small-business owners choosing an invoicing tool.",
            "evidence": "The live article links to FreshBooks, Zoho, QuickBooks and Wave, and the site publishes info@founderreports.com on its contact page.",
            "confidence": "high",
        },
    },
    {
